I have an AI Accelerator mini project about resume-job analysis using LLMs. 
I want to adapt this project to VLAs for robotics in agriculture. 
...
Please convert this project to my chosen domain. Keep every technical requirement and success criterion exactly in place. Only change the domain, example data, and scenario descriptions.

If it is not possible to adapt this project to my chosen domain while keeping all technical and learning requirements the same, please tell me why and suggest a different domain that would work well.